...
<div>
       <label for="contributor" accesskey="c"><?php echo LABEL_Contributor;?></label>
...
<div>
       <label for="rights" accesskey="c"><?php echo LABEL_Rights;?></label>
        <input id="rights"
    name="dcrights"
    size="50"
    maxlength="250"
...
<div>
       <label for="publisher" accesskey="c"><?php echo LABEL_Publisher;?></label>
        <input id="publisher"
    name="dcpublisher"
    size="50"
    maxlength="250"
